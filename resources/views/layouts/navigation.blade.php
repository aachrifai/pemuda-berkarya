<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('img/logo.png') }}" alt="Logo Pemuda Berkarya" class="block h-12 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.pemuda.index')" :active="request()->routeIs('admin.pemuda.*')">
                        {{ __('Data Anggota') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.pemuda.index')" :active="request()->routeIs('admin.pemuda.*')">
                {{ __('Data Anggota') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('slider.index')" :active="request()->routeIs('slider.*')">
                {{ __('Kelola Slide Show') }}
            </x-responsive-nav-link>
        </div>
